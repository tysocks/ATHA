# Historical / external reference datasets

Workstream 6.4 reference packages. Each folder contains `manifest.yaml` plus a
trace file. See `docs/HISTORICAL_CORRELATION.md`.
